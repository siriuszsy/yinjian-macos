...
`如果 voiceKey 要在本地替代 竞品，最少要做到什么程度才配叫替代？`

信息来源分两类：

- 竞品 官方公开页面与发布说明
- 本机已有 竞品 安装痕迹与既有内部调研笔记
...
如果 voiceKey 只做到“ASR 很准”，但没有这层输入体验，用户感知会明显低于 竞品。

## 3. 已验证的公开事实

### 3.1 定价

根据 竞品 官方定价页，2026-04-10 时点的信息如下：
...
公开 release notes 说明 竞品 不是只堆功能，它在持续打磨输入层细节。
...
- Bundle Identifier：`now.competitor.desktop`
...
已有内部笔记对 竞品 的总结很一致，重点不在“聊天”，而在“整理”。
...
- 纯本地更容易快
- 混合后处理更容易接近 竞品 的最终文本质量
- 真正影响日用体验的，不只是识别字对不对，还包括收尾和文本整理

### 6.3 错误路线

下面几条很容易做出一个“看起来像”，但日常根本替代不了 竞品 的产品：
...
- 说明它更像可借壳参考，不是直接满足 voiceKey 要求的成品
...
这是 voiceKey 跨应用工作的基础，不是可选项。

## 8. 结论

voiceKey 如果要真的替代 竞品，优先级应该是：
...
- https://www.competitor.com/help/quickstart/key-features
- https://www.competitor.com/help/release-notes/macos
- https://www.competitor.com/help/release-notes/macos/personalized-smarter
- https://www.competitor.com/help/release-notes/macos/translation-mode
